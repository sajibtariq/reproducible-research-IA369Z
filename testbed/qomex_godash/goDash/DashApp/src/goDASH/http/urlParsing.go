...
// * return the rtt
func getURLProgressively(url string, isByteRangeMPD bool, startRange int, endRange int, fileLocation string) (time.Duration, string) {
 ...
 */
func GetFileProgressively(currentURL string, fileBaseURL string, fileLocation string, isByteRangeMPD bool, startRange int, endRange int, segmentNumber int, segmentDuration int, addSegDuration bool, debugLog bool) (time.Duration, int, string, string) {
	...
	//request the URL with GET
	rtt, protocol := getURLProgressively(urlHeaderString, isByteRangeMPD, startRange, endRange, createFile)
